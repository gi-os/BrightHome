#!/usr/bin/env python3
"""Build BrightHome's launcher mark.
...
MARK = [
    # A house: roof chevron, walls, and one filled roundel where a light would be.
    ('M24,56 L54,26 L84,56', 5, False),
    ('M33,50 V82 H75 V50', 5, False),
    ('M48.00,66.00 A6.00,6.00 0 1 1 60.00,66.00 A6.00,6.00 0 1 1 48.00,66.00 Z', 0, False),
]
...
TARGETS = [
    ('examples/BrightHome/src/main/res/drawable/ic_launcher_foreground.xml', 108),
...
RASTERS = [
    ('examples/BrightHome/src/main/res/mipmap-hdpi/ic_launcher.png', 72, False, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-hdpi/ic_launcher_foreground.png', 72, False, 1.0, True),
    ('examples/BrightHome/src/main/res/mipmap-hdpi/ic_launcher_round.png', 72, True, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-mdpi/ic_launcher.png', 48, False, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-mdpi/ic_launcher_foreground.png', 48, False, 1.0, True),
    ('examples/BrightHome/src/main/res/mipmap-mdpi/ic_launcher_round.png', 48, True, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xhdpi/ic_launcher.png', 96, False, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xhdpi/ic_launcher_foreground.png', 96, False, 1.0, True),
    ('examples/BrightHome/src/main/res/mipmap-xhdpi/ic_launcher_round.png', 96, True, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xxhdpi/ic_launcher.png', 144, False, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xxhdpi/ic_launcher_foreground.png', 144, False, 1.0, True),
    ('examples/BrightHome/src/main/res/mipmap-xxhdpi/ic_launcher_round.png', 144, True, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xxxhdpi/ic_launcher.png', 192, False, 0.72, False),
    ('examples/BrightHome/src/main/res/mipmap-xxxhdpi/ic_launcher_foreground.png', 192, False, 1.0, True),
    ('examples/BrightHome/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png', 192, True, 0.72, False),
...
STATIC = [
    ('examples/BrightHome/src/main/res/drawable/ic_launcher_background.xml', '<?xml version="1.0" encoding="utf-8"?>\n<!-- Solid black plate. The whole set is black and white; nothing else belongs here. -->\n<vector xmlns:android="http://schemas.android.com/apk/res/android"\n    android:width="108dp"\n    android:height="108dp"\n    android:viewportWidth="108"\n    android:viewportHeight="108">\n    <path\n        android:pathData="M0,0 H108 V108 H0 Z"\n        android:fillColor="#000000" />\n</vector>\n'),
    ('examples/BrightHome/src/main/res/mipmap-anydpi-v26/ic_launcher.xml', '<?xml version="1.0" encoding="utf-8"?>\n<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">\n    <background android:drawable="@drawable/ic_launcher_background" />\n    <foreground android:drawable="@drawable/ic_launcher_foreground" />\n    <monochrome android:drawable="@drawable/ic_launcher_foreground" />\n</adaptive-icon>\n'),
    ('examples/BrightHome/src/main/res/mipmap-anydpi-v26/ic_launcher_round.xml', '<?xml version="1.0" encoding="utf-8"?>\n<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">\n    <background android:drawable="@drawable/ic_launcher_background" />\n    <foreground android:drawable="@drawable/ic_launcher_foreground" />\n    <monochrome android:drawable="@drawable/ic_launcher_foreground" />\n</adaptive-icon>\n'),
...
<!--
  BrightHome launcher mark. One of the unified Bright* set: 108 canvas, 18..90
